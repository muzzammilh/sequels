...
const NavBar = ({searchBgColor, onClickFilter,
  onClickNotification, onClickLogo, onChangeSearch, onClickProfile,
logoUrl, profileUrl}) => {
   const [onPClick, setPClick] = useState(0);
  return (
    <div className='fixed container justify-self-center top-0'>
