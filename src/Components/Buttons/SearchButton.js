...
function SearchButton() {
  return (
    <div className='flex  justify-center items-center' >
        <div className='flex rounded-full justify-center items-center px-4' style={{backgroundColor:colors.gray}}>
            <div>
            <svg width="20" height="23" viewBox="0 0 25 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <line x1="13.1196" y1="14.0848" x2="23.0848" y2="24.8804" stroke="#0E222B" stroke-width="3" stroke-linecap="round"/>
            </svg>
